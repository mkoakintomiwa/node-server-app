...
var conn = exports.conn = function(db_name=null,db_user=null,db_password,host="localhost"){
...
var conn_files = exports.conn_files = function(){
    return mysql.createConnection({
        host: 'localhost',
        user: 'root',
        database: db+"_files",
...
var fetch = exports.fetch = async function(query,parameters=[],db_conn){
    return execute(query,parameters,db_conn);   
}



var fetchOne = exports.fetchOne = async function(query,parameters=[],db_conn){

    let rows = await fetch(query,parameters,db_conn);
...
class row_action{
    ...
    statement(){
        ...
        var query_append = fx.setDefault(db_parameters['query_append'],""); 
